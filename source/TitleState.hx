...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		FlxTween.tween(bg, {y: bg.x + 10}, 12312321, {ease: FlxEase.quadInOut, type: LOOPING});
		...
		FlxTween.tween(credTextShit, {y: credTextShit.y + 20}, 2.9, {ease: FlxEase.quadInOut, type: LOOPING});
	...
	override function update(elapsed:Float)
	{
		...
		if (pressedEnter && !transitioning && skippedIntro)
		{
			...
			FlxTween.tween(FlxG.camera, {zoom: 3.05}, 0.3, {ease: FlxEase.quadOut, type: BACKWARD});
